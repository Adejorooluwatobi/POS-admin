...
export class DataService {
  ...
  public stores: Record<string, Store> = {
    'LG-01': { code: 'LG-01', name: 'Victoria Island Store', city: 'Lagos', address: '23 Adeola Hopewell, VI', terminals: 4, active: true, },
    'LG-02': { code: 'LG-02', name: 'Ikeja Store', city: 'Lagos', address: '15 Allen Avenue, Ikeja', terminals: 3, active: true },
  };
